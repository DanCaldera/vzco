    ...
    <div className='bg-white pb-8 sm:pb-12 lg:pb-12'>
      <div className='overflow-hidden pt-8 sm:pt-12 lg:relative lg:py-48'>
        <div className='mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-24 lg:px-8'>
          <div>
            <div>
              <Image width={50} height={50} src='https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600' alt='Your Company' />
            </div>
            <div className='mt-20'>
              <div>
                <a href='#' className='inline-flex space-x-4'>
                  <span className='rounded bg-indigo-50 px-2.5 py-1 text-sm font-semibold text-indigo-600'>{"What's new"}</span>
              ...
              <div className='mt-6 sm:max-w-xl'>
                <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl'>Server management for growing teams</h1>
